...
const About = () => {
  return (
    <p className='about-us w-full md:px-40 max-sm:px-4 pt-10 pb-20 min-h-fit font-[400] max-sm:text-xl text-2xl text-neutral-300'>
        ...
        with Apricity, your project is not just another job, it's a shared journey towards something extraordinary.
    </p>
  )
}
